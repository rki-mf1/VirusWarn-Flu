...
Sequences are sent to a category (Red, Orange, Yellow, Grey) according to their mutation profile. FluWarnSystem counts the amount of mutations in 3 categories:
...
alert_colors <- c(grey = "lightgrey", yellow= "#FFEA00", orange = "orange", red = "red")
...
if (params$metadata == ""){
  ...
  if (nrow(df_bar) != 5){
    all_alert_levels <- c('grey', 'yellow', 'orange', 'red')
  ...
  order_levels <- c('grey', 'yellow', 'orange', 'red')
